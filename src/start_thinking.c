...
/*   Updated: 2024/10/09 10:28:23 by iniska           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../philo.h"

static bool	spawn_philos(t_cave *cave)
{
	int	i;
	...
	{	
		if (pthread_create(&cave->philos[i].thread_id,
				NULL, routine, &cave->philos[i]) != 0)
		{
